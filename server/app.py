...
"""
FastAPI application for the Music Recommendation Environment.

This module creates an HTTP server that exposes the MusicRecommendationEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m music_recommendation.server.app
    ...
    multiple workers:
        uvicorn music_recommendation.server.app:app --workers 4
    """
    import uvicorn
